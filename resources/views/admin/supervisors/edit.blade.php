...
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0">Edit Supervisor</h1>
            <a href="{{ route('admin.supervisors.index') }}" class="btn btn-outline-secondary">
                <i class="fas fa-arrow-left me-2"></i>Back to Supervisors
            </a>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-8">
        <div class="stats-card">
            <div class="d-flex align-items-center mb-4">
                ...
                <h5 class="mb-0">Edit Supervisor Information</h5>
            </div>
            
            <form method="POST" action="{{ route('admin.supervisors.update', $supervisor) }}">
                @csrf
                @method('PUT')
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="phone_number" value="{{ old('phone_number', $supervisor->phone_number) }}" required 
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="district_id" id="district_id" required 
                            ...
                            @foreach($districts as $district)
                                <option value="{{ $district->id }}" {{ old('district_id', $supervisor->district_id) == $district->id ? 'selected' : '' }}>
                                    {{ $district->name }}
                                </option>
                            @endforeach
                        </select>
        ...
        fetch(`/admin/mandals/${districtId}`)
            ...
            .then(data => {
                data.forEach(mandal => {
                    ...
                    option.selected = mandal.id == {{ old('mandal_id', $supervisor->mandal_id) }};
