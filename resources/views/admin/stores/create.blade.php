...
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0">Create Store</h1>
            ...
            <form method="POST" action="{{ route('admin.stores.store') }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="validity_period" required class="form-select">
                            <option value="6" {{ old('validity_period') == '6' ? 'selected' : '' }}>6 Months</option>
                            <option value="12" {{ old('validity_period') == '12' ? 'selected' : '' }}>12 Months</option>
                        </select>
                    </div>
