...
<div class="stats-card mb-4">
    ...
    <form method="GET" action="{{ route('supervisor.purchase-history.index') }}">
        <div class="row g-3">
            <div class="col-md-8">
...
function viewSaleDetails(saleId) {
    ...
    const saleData = {
        ...
        store: row.cells[2].textContent,
        district: row.cells[3].textContent,
        mandal: row.cells[4].textContent,
        quantity: row.cells[5].querySelector('.badge').textContent,
        balanceBefore: row.cells[6].textContent,
        balanceAfter: row.cells[7].textContent,
        soldBy: row.cells[8].textContent
    };
    ...
    const content = `
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                <strong>Store Name:</strong> ${saleData.store}
            </div>
            <div class="col-md-6 mb-3">
                <strong>Store District:</strong> ${saleData.district}
            </div>
            <div class="col-md-6 mb-3">
                <strong>Store Mandal:</strong> ${saleData.mandal}
            </div>
            <div class="col-md-6 mb-3">
